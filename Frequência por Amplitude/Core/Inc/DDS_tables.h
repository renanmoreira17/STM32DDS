 ...
 * 	   License: GPLv3.0
 */
#ifndef INC_DDS_TABLES_H_
#define INC_DDS_TABLES_H_

#include "stdint.h"

const uint32_t FTW_LUT[] = {
		85899346, 171798692, 257698038, 343597384, 429496730,
		515396076, 601295421, 687194767, 773094113, 858993459
};
